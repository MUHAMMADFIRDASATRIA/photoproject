...
export const DashboardLayout: React.FC = () => {
  ...
  return (
    <div className={`flex h-screen overflow-hidden bg-zinc-950 font-sans text-zinc-100 ${themeClass(theme)}`}>
      {/* Sidebar */}
        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-zinc-800/80 bg-zinc-900/40 px-8 backdrop-blur-xl">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-xl border border-zinc-800 bg-zinc-900/60 text-zinc-300 transition hover:bg-zinc-800 hover:text-amber-400"
            >
              {theme === 'light' ? (
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
